...
public class ProjectController {
	...
	@PostMapping("/create")
	public String createProcess(Model model, ProjectBindingModel projectBindingModel, BindingResult bindingResult) {
	...
	@PostMapping("/edit/{id}")
	public String editProcess(@PathVariable int id, Model model, ProjectBindingModel projectBindingModel, BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			model.addAttribute("message", "Invalid data.");
			model.addAttribute("project", projectBindingModel);
			model.addAttribute("view", "project/edit");
